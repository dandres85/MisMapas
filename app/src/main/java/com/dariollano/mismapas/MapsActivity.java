...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng yopal = new LatLng(4.664029784827444,-74.09593121664997);
        mMap.addMarker(new MarkerOptions().position(yopal).title("Marker in yopal"));

        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(monserrate, 13));
